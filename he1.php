...
<nav class="navbar">
<a href="login_mentor.php" ><i class="fas fa-user"></i>
<br>
...
document.querySelector('#search-btn').onclick = () =>{
   ...
   profile.classList.remove('active');
    ...
    <nav class="navbar">
        ...
        <a href="login.php"> Login/signup as Student</a>
    </nav>
...
We allows access to educational resources from anywhere with an internet connection, breaking down geographical barriers.</p>
        <a href="course.php" class="btn"> our courses <span class="fas fa-chevron-right"></span> </a>
    </div>
