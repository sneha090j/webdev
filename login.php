                ...
                <section class="form-container">
                    ...
                    <form action="" method="POST" class="login">
                       ...
                       <br>
                        ...
                        <h4>Name: <h4><input type="text" name="name" placeholder="enter your name" maxlength="20" required class="box">
                      
                       <br>
                       <h4>Email: <h4> <input type="email" name="email" placeholder="enter your email" maxlength="20" required class="box">
                      
                       <br>
                      
                       Password: <h4><input type="password" name="password" placeholder="enter your password" maxlength="10" required class="box">
                       
                       <p class="link">don't have an account? <a href="sn.php">Sign now</a></p>
...
<?php
    ...
    if(isset($_POST['login'])){
        ...
        $query= "SELECT * FROM learn WHERE email = '$email' && password = '$password'";
