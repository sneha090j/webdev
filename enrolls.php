    ...
    <div id="bd">
        <div id="im">
         ...
         <br>
            ...
            <br>
            <br>
            Think of sequences of numbers, or tables of data: these are both well-defined data structures. An algorithm is a sequence of steps executed by a computer that takes an input and transforms it into a target output.
           <br>
           <br>
           <br>
...
if(isset($_POST['submit'])){
    ...
    $mail->Body = "Welcome to Hello World ".$name."\nEmail: ".$email."\nPhone: ".$number."n Thank you for enrolling in course: ".$course  ; // Body of the email
    $mail->addAddress($email);

    if ($mail->Send()) {
       echo "<script>alert('Enrolled successfully!Confirmed Mail has been sent to your registered email.')</script>";
