...
.form-container .link a{
   ...
   .cn a{
    ...
    <h1><b><i><u> <center>E-Learning admin</center> </u></i></b></h1>
    <div id="bd">
        <div id="im">
    ...
    <section class="form-container">
      ...
      <h3><center>mentor registeration</center></h3>
   ...
   <br>
   <input type="text" name="dept" placeholder="enter your subject" maxlength="20" required class="box">
   <br>
   <p class="link">Have an account? <a href="login_mentor.php">login now</a></p>
       ...
       if($_POST['submit'])
        {
          ...
          $query = "INSERT INTO tutor VALUES('id','$name','$email','$number','$pass','$dept')";
